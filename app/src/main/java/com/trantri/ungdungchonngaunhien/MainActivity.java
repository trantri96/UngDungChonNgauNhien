package com.trantri.ungdungchonngaunhien;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNumber = (TextView) findViewById(R.id.textViewRandom);
        ...
        btnRandom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (chuoi1.length() == 0 || chuoi2.length() == 0){
                    Toast.makeText(MainActivity.this, "Mời Bạn Nhập Đầy Đủ Số !" ,Toast.LENGTH_SHORT).show();
                }
                else {
